...
def advance():
    window.title("Strange's Advance Calculator")
...
key_bracket_open = Button(button_frame, bg='white', border=2, text="(", width=9,
                          height=2, command=lambda: press('('))
key_bracket_open.grid(row=0, column=0)

key_bracket_close = Button(button_frame, bg='white', border=2, text=")", width=9,
                           height=2, command=lambda: press(')'))
key_bracket_close.grid(row=0, column=1)

key_adv = Button(button_frame, bg='white', border=2, text="open adv", width=9,
                 height=2, command=advance)
key_adv.grid(row=0, column=2)

key_bc = Button(button_frame, bg='white', border=2, text="<", width=9,
                height=2, command=back_space)
key_bc.grid(row=0, column=3)

key_sin = Button(button_frame, bg='white', border=2, text="sin", width=9,
                 height=2, command=lambda: trig('sin'))
key_sin.grid(row=0, column=4)

key1 = Button(button_frame, bg='white', border=2, text="1", width=9,
              height=2, command=lambda: press(1))
key1.grid(row=1, column=0)

key2 = Button(button_frame, bg='white', border=2, text="2", width=9,
              height=2, command=lambda: press(2))
key2.grid(row=1, column=1)

key3 = Button(button_frame, bg='white', border=2, text="3", width=9,
              height=2, command=lambda: press(3))
key3.grid(row=1, column=2)

key_add = Button(button_frame, bg='white', border=2, text="+", width=9,
                 height=2, command=lambda: press('+'))
key_add.grid(row=1, column=3)

key_cos = Button(button_frame, bg='white', border=2, text="cos", width=9,
                 height=2, command=lambda: trig('cos'))
key_cos.grid(row=1, column=4)

key4 = Button(button_frame, bg='white', border=2, text="4", width=9,
              height=2, command=lambda: press(4))
key4.grid(row=2, column=0)

key5 = Button(button_frame, bg='white', border=2, text="5", width=9,
              height=2, command=lambda: press(5))
key5.grid(row=2, column=1)

key6 = Button(button_frame, bg='white', border=2, text="6", width=9,
              height=2, command=lambda: press(6))
key6.grid(row=2, column=2)

key_sub = Button(button_frame, bg='white', border=2, text="-", width=9,
                 height=2, command=lambda: press('-'))
key_sub.grid(row=2, column=3)

key_tan = Button(button_frame, bg='white', border=2, text="tan", width=9,
                 height=2, command=lambda: trig('tan'))
key_tan.grid(row=2, column=4)

key7 = Button(button_frame, bg='white', border=2, text="7", width=9,
              height=2, command=lambda: press(7))
key7.grid(row=3, column=0)

key8 = Button(button_frame, bg='white', border=2, text="8", width=9,
              height=2, command=lambda: press(8))
key8.grid(row=3, column=1)

key9 = Button(button_frame, bg='white', border=2, text="9", width=9,
              height=2, command=lambda: press(9))
key9.grid(row=3, column=2)

key_mul = Button(button_frame, bg='white', border=2, text="x", width=9,
                 height=2, command=lambda: press('*'))
key_mul.grid(row=3, column=3)

key_root = Button(button_frame, bg='white', border=2, text="root", width=9,
                  height=2, command=lambda: trig('sqr'))
key_root.grid(row=3, column=4)

key_cut = Button(button_frame, bg='white', border=2,
                 text="Clear", width=9, height=2, command=cut)
key_cut.grid(row=4, column=0)

key0 = Button(button_frame, bg='white', border=2, text="0", width=9,
              height=2, command=lambda: press(0))
key0.grid(row=4, column=1)

key_dec = Button(button_frame, bg='white', border=2, text=".",
                 width=9, height=2, command=lambda: press('.'))
key_dec.grid(row=4, column=2)

key_div = Button(button_frame, bg='white', border=2, text="/", width=9,
                 height=2, command=lambda: press('/'))
key_div.grid(row=4, column=3)

key_square = Button(button_frame, bg='white', border=2, text="square", width=9,
                    height=2, command=lambda: trig('sq'))
key_square.grid(row=4, column=4)

key_equal = Button(button_frame, bg='white', border=2, text="=", width=40,
                   height=2, command=solve)
key_equal.grid(row=5, column=0, columnspan=4)

key_log = Button(button_frame, bg='white', border=2, text="log", width=9,
